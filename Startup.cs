...
namespace ProCare.API.PBM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Debug.WriteLine("");
                Debug.WriteLine("<<<<<<<<<<<<<<<<<<<<   PBM API STARUTP ERROR   >>>>>>>>>>>>>>>>>>>>>");
                Debug.WriteLine(ex);
                Debug.WriteLine("<<<<<<<<<<<<<<<<<<<< END PBM API STARUTP ERROR >>>>>>>>>>>>>>>>>>>>>");
                Debug.WriteLine("");
            }
        ...
        private string getApplicationInsightsInstrumentationKey()
        {
            ...
            try
            {
                CommonApiHelper commonApiHelper = new CommonApiHelper(ApplicationSettings.CommonApiBaseUrl, ApplicationSettings.CommonApiUsername,
                                                                      ApplicationSettings.CommonApiPassword);
                ...
                output = results[ConfigSetttingKey.InstrumentationKey_PBMAPI];
            }
            catch
            {
            }
